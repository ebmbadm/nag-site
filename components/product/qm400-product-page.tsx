  ...
  return (
    <Surface mode="dark">
      ...
      <section className="border-b border-border">
        <Container className="grid lg:grid-cols-[1.1fr_0.9fr]">
          <Image
            ...
            className="h-[300px] w-full object-cover lg:h-[380px]"
          />
          <div className="flex flex-col justify-center border-x border-border p-8 lg:p-12">
            ...
            <p className="mt-5 leading-relaxed text-text-muted">
              QM-400 объединяет четыре автономных канала Class‑TD. Каждый канал имеет
              собственный блок питания: это снижает взаимное влияние каналов и позволяет
              усилителю продолжать работу даже при отключении одного из них.
            </p>
          </div>
        </Container>
      </section>
      ...
      <section className="py-12 lg:py-16">
        <Container className="grid gap-px bg-border sm:grid-cols-3">
