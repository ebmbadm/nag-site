---
name: "AMP By NAG CX"
line: "Архивная модель · AMP by NAG"
subtitle: "4 × 700 Вт Class-D со встроенным DSP"
badges: ["АРХИВ", "Class-D · DSP"]
archived: true
...
specChips:
  ...
  - "11.9 кг"
docs:
  - { label: "Руководство пользователя", href: "/downloads/amp-by-nag-cx-manual-ru.pdf" }
  - { label: "ПО для Windows", href: "/downloads/dsp-by-nag-the-rogue-software.zip" }
models:
  - { name: "CX-520", config: "4 × 700 Вт · 2 × 4 DSP", note: "2 входа" }
  - { name: "CX-540", config: "4 × 700 Вт · 4 × 4 DSP", note: "4 входа" }
gallery:
