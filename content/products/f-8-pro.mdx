...
docs:
  - { label: "Руководство пользователя", href: "/downloads/nag-f-8-pro-manual-ru.pdf" }
  - { label: "Техническое описание серии NAG F", href: "/downloads/nag-f-series-specs.pdf" }
  - { label: "ПО Mconsole V2.8.22 для Windows", href: "/downloads/nag-f-8-pro-mconsole-v2.8.22.zip" }
specGroups:
