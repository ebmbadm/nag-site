...
features:
  ...
  cards:
    ...
    - { icon: "zap", title: "Мощность Class-TD", text: "4 × 2400 Вт на 4 Ω, до 2 × 4200 Вт в мостовом режиме." }
...
QM-400 унифицирован по элементам и сервису с линейкой усилительных модулей NAG TDS/TDH: схемотехнически это четыре модуля TDS/TDH-20 в одном корпусе. В четырёхканальном режиме - 4 × 2400 Вт на 4 Ω, в мостовом - до 2 × 4200 Вт на 4 Ω.
