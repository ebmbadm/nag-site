...
price:
  amount: 199900
  currency: "₽"
  note: "Без НДС · Гарантия 2 года"
summary: "Флагманский четырёхканальный усилитель NAG Class-TD для профессиональных систем. Один аппарат закрывает несколько независимых линий усиления и поддерживает мостовой режим там, где нужен больший запас мощности."
specChips:
  - "4 × 2400 Вт (4 Ω)"
  - "Class-TD"
  ...
  - "17.3 кг"
docs:
  - { label: "Руководство пользователя", href: "/downloads/nag-qm-400-manual-ru.pdf" }
gallery:
...
features:
  ...
  cards:
    ...
    - { icon: "zap", title: "Мощность Class-TD", text: "4 × 2400 Вт на 4 Ω и 2 Ω, до 2 × 4800 Вт в мостовом режиме на 8 Ω." }
...
specGroups:
  - title: "Четырёхканальный режим"
    ...
    rows:
      ...
      - { label: "Мощность 4 Ω (RMS, 1 кГц, 1% THD)", value: "4 × 2400 Вт" }
      - { label: "Мощность 2 Ω (RMS, 1 кГц, 1% THD)", value: "4 × 2400 Вт" }
  - title: "Мостовой режим (bridge)"
    rows:
      - { label: "Мощность 8 Ω (EIA, 1 кГц, 1% THD)", value: "2 × 4800 Вт" }
...
QM-400 унифицирован по элементам и сервису с линейкой усилительных модулей NAG TDS/TDH: схемотехнически это четыре модуля TDS/TDH-20 в одном корпусе. В четырёхканальном режиме - 4 × 2400 Вт на 4 Ω и 2 Ω, в мостовом - до 2 × 4800 Вт на 8 Ω.
