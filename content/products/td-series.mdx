...
specChips:
  ...
  - "1U / 1.5U"
docs:
  - { label: "Руководство TD-30 / TD-40", href: "/downloads/nag-td-30-40-manual-ru.pdf" }
  - { label: "Руководство TD-80 / TD-100", href: "/downloads/nag-td-80-100-manual-ru.pdf" }
models:
  ...
  - { name: "TD-100", config: "2 × 2400 Вт (4 Ω)", price: 120900, note: "1.5U" }
gallery:
...
features:
  ...
  cards:
    ...
    - { icon: "layers", title: "Мостовой режим", text: "Основной режим bridge рассчитан на нагрузку 8 Ω." }
...
specMatrix:
  ...
  rows:
    ...
    - { label: "4 Ω стерео", values: ["2 × 400 Вт", "2 × 600 Вт", "2 × 1400 Вт", "2 × 2400 Вт"] }
    - { label: "2 Ω стерео", values: ["2 × 400 Вт", "2 × 600 Вт", "2 × 1500 Вт", "2 × 2400 Вт"] }
    - { label: "8 Ω bridge", values: ["700 Вт", "1100 Вт", "2800 Вт", "4800 Вт"] }
...
Каскады развивают заявленную мощность без мостового включения в каждом канале, поэтому усилители стабильно работают на нагрузке 2 Ω. Основной моно-режим (bridge) рассчитан на 8 Ω. TD-30 и TD-40 - в корпусе 1U, TD-80 и TD-100 - 1.5U.

Подробный разбор классов усиления — [Class-TD: что это и чем отличается от Class-D](/class-td).
